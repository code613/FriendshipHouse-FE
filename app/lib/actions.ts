...
import { SumbitState } from "../interfaces/submit-state";
...
export async function submitReservation(
  state: SumbitState | undefined,
  payload: FormData
): Promise<SumbitState | undefined> {
  try{
    console.log(payload);
    ...
    return {
      isSuccess: false,
      message: "Unable to submit reservation, please try again later."
    }
  }
